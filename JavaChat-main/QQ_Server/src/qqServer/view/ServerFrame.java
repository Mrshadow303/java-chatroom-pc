...
public class ServerFrame extends JFrame{
	...
	public ServerFrame() {
		...
		btn_Start.setForeground(new Color(238,130,238));
		btn_Start.setFont(new Font("黑体", Font.PLAIN, 16));
		btn_Send = new JButton("推送消息");
		btn_Send.setForeground(new Color(132,112,255));
		btn_Send.setFont(new Font("黑体", Font.PLAIN, 16));
		
		txt_Send = new JTextField(30);
